<div class="row mb-3">
    ...
    <div class="col-md-4">
        <label for="hora_limite" class="form-label">Hora Limite</label>
    ...
    <div class="col-md-4">
        ...
        <select name="prioridade" id="prioridade" class="form-select">
            <option value="Baixa" {{ old('prioridade', $schedule->prioridade ?? '') == 'Baixa' ? 'selected' : '' }}>Baixa</option>
            <option value="Média" {{ old('prioridade', $schedule->prioridade ?? '') == 'Média' ? 'selected' : '' }}>Média</option>
            <option value="Alta"  {{ old('prioridade', $schedule->prioridade ?? '') == 'Alta' ? 'selected' : '' }}>Alta</option>
        </select>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-md-3">
        <label for="repetir" class="form-label">Repetição</label>
        <select name="repetir" id="repetir" class="form-select">
            <option value="0" {{ old('repetir', $schedule->repetir ?? false) == false ? 'selected' : '' }}>Não repete</option>
            <option value="1" {{ old('repetir', $schedule->repetir ?? false) == true ? 'selected' : '' }}>Repetir</option>
        </select>
    </div>
...
<div class="mt-4">
    <label class="form-label">Selecionar Colaboradores</label>
